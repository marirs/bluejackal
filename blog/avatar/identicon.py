...
based from richardasaurus/randomavatar
"""
...
class Avatar(object):
    ...
    def _generate_colours(self):
        # make sure colors generate from seed
        self.fg_colour = self._get_pastel_colour(lighten=17, seed=self.seed)
        self.bg_colour = self._get_pastel_colour(lighten=150, seed="transparent")
    ...
    def get_image(self, seed, width, height, pad=0):
        """
          Byte representation of a PNG image
        """
        self.seed = seed
        self._generate_colours()
        hex_digest_byte_list = self._string_to_byte_list(seed)
    ...
    def _get_pastel_colour(self, lighten=127, seed=""):
        """
